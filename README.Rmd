...
---
# README for: Explaining Recruitment to Extremism: A Bayesian Hierarchical Case-Control Approach

![](margins.png)

Repo of replication materials for "Explaining Recruitment to Extremism: A Bayesian Hierarchical Case-Control Approach."

**Note that point estimates in these replication materials differ very slightly from the published estimates. This is due to minor differences in posterior samples as a result of MCMC sampling procedures.**
